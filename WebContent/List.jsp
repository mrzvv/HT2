...
<table align="center" width="90%">
    ...
    <tr>
     	<td colspan="6" align="center"><a style="color: green;" href="<%=request.getContextPath()%>/?action=addPerson">Добавить запись</a></td>
    </tr>
    <tr>
        ...
        %>
          <tr>
           ...
           <td><a style="color: orange;" href="<%=request.getContextPath()%>/?action=editPerson&amp;id=<%=person.getId()%>">Редактировать</a></td>
           <td><a style="color: red;"href="<%=request.getContextPath()%>/?action=deletePerson&amp;id=<%=person.getId()%>">Удалить</a></td>
          </tr>
        <%
          }
        %>
